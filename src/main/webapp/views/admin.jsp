          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="tables">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="simple-page">Adminstrator </a>
                  </li>
                </ul>
              </div>
            </li>
                    ...
                    >
                      ...
                      <div class="row">
                        <div class="col-lg-8 d-flex flex-column">
                                ...
                                <div class="card-body">
                                  <div class="col-sm-8">
                                    <h3 class="text-white upgrade-info mb-0">
                                      Enhance your
                                      <span class="fw-bold">Campaign</span> for
                                      better outreach
                                    </h3>
                                    <a href="#" class="btn btn-info upgrade-btn"
                                      >Upgrade Account!</a
                                    >
                                  </div>
                                </div>
                          ...
                          <div class="row flex-grow">
                            <div
                              class="col-md-6 col-lg-6 grid-margin stretch-card"
                            >
                              <div class="card card-rounded">
                                    ...
                                    <div class="wrapper w-100">
                                      ...
                                      >
                                        <div class="d-flex align-items-center">
                                          <i
                                            class="mdi mdi-calendar text-muted me-1"
                                          ></i>
                                          ...
                                          <li class="d-block">
                                            <div class="form-check w-100">
                                              ...
                                              <div class="d-flex mt-2">
                                                ...
                                                <i
                                                  class="mdi mdi-flag ms-2 flag-color"
                                                ></i>
                                              </div>
                                            </div>
                                          </li>
