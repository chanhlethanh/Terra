        ...
        <div class="row">
          <div class="col-lg-8">
            <div class="left-images">
              <img src="/assets/index_files/${detailProduct.image}" alt="" />
            </div>
          </div>
          <div class="col-lg-4">
                ...
                <div class="col-lg-12">
                    <div class="men-item-carousel">
                        ...
                        <c:forEach var="product" items="${products}">
                        	<c:if test="${product.categoryid eq '1'}">
                            <div class="item">
                ...
                <div class="col-lg-12">
                    <div class="women-item-carousel">
                        <div class="owl-women-item owl-carousel">
                           <c:forEach var="product" items="${products}">
                        	<c:if test="${product.categoryid eq '2'}">
                            <div class="item">
                                <div class="thumb">
                                    <div class="hover-content">
                                        <ul>
                                            <li><a href="/single-product/${product.id}"><i class="fa fa-eye"></i></a></li>
        ...
        <div class="row">
          <div class="col-lg-8">
            <div class="section-heading">
              ...
              <span
                >Details to details is what makes different from the other
                themes.</span
              >
            </div>
